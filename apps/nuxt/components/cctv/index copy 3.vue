                ...
                <div class="grid-stack">
                    <template v-for="(item, index) in state.childrenROI" :key="index">
                        <div class="grid-stack-item"
                            ...
                            :style="{ zIndex: state.focusPage === item.option.camID && item.type === 1 ? 999 : item.z, opacity: state.savedownID === item.option.container_index ? 0.3 : 1 }"
                            @mousedown="item.type !== 4 && state.focusPage !== item.option.camID && item.type !== 1 ? itemMouseDown(item.option.tabId, item.option.container_index) : ''"
                            ...
                            <div class="grid-stack-item-content">
                                ...
                                <template v-else-if="item.type === 9">
                                    <div style="width: 100%; height:100%;overflow: hidden;border: #747474 1px solid;">
                                        <div class="grid-stack" :ref="(e) => addnested(e)">
                                            <!-- 右上 -->
                                            <div class="grid-stack-item" :gs-x="0" :gs-y="0" :gs-w="30" :gs-h="5"
                                                :gs-id="4">
                                                            ...
                                                            <div class="d-flex flex-column align-center justify-center"
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="d-rect-www01 mr-1"
                                                                        :style="item.option.hmi.alarm_info.roiAlarm_status === 1 ? 'background:#FF0000;' : 'background:#CFCFCF;'">
                                                                    </div>
                                                                    <div>超溫監測</div>
                                                                </div>
                                                                <div class="d-flex my-4">
                                                                    <div class="d-rect-www01 mr-1"
                                                                        :style="item.option.hmi.alarm_info.smokeAlarm_status === 1 ? 'background:#FF0000;' : 'background:#CFCFCF;'">
                                                                    </div>
                                                                    <div>煙霧監測</div>
                                                                </div>
                                                                <div class="d-flex">
                                                                    <div class="d-rect-www01 mr-1"
                                                                        :style="item.option.hmi.alarm_info.ptz_working_status === 1 ? 'background:#FF0000;' : 'background:#CFCFCF;'">
                                                                    </div>
                                                                    <div>巡弋狀態</div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex align-end justify-end">
                                                                <div class="d-flex flex-column align-end">
                                                                    <div style="font-size: 56px;line-height: 1;">
                                                                        {{
                                                                            item.option.hmi.realtime_roiCurve.roi_thresholdManual
                                                                        }}</div>
                                                                    <div>℃</div>
                                                                    <div class="c-switch-lo20">
                                                                        <div class="c-switch-a20"
                                                                            :class="item.option.hmi.alarm_info.ptz_working_status === 1 ? 'c-switch-foucs20' : 'c-switch-after-add20'"
                                                                            @click="ptzswitchEvent(1)">
                                                                            閒置中
                                                                        </div>
                                                                        <div class="c-switch-b20"
                                                                            :class="item.option.hmi.alarm_info.ptz_working_status === 2 ? 'c-switch-foucs20' : ''"
                                            ...
                                            <!-- 右下 -->
                                            <div class="grid-stack-item" :gs-x="0" :gs-y="4" :gs-w="30" :gs-h="5"
                                                :gs-id="3">
                                                <div class="grid-stack-item-content" style="background-color: #FFF;">
                                            ...
                                            <!-- 左上 -->
                                            <div class="grid-stack-item" :gs-x="30" :gs-y="0" :gs-w="20" :gs-h="5"
                                                :gs-id="4">
                                                <div class="grid-stack-item-content" style="background-color: #FFF;">
                                                    <div style="width: 100%; height:100%;overflow: hidden;">
                                                        <ClientOnly>
                                            ...
                                            <!-- 左下 -->
                                            <div class="grid-stack-item" :gs-x="30" :gs-y="5" :gs-w="20" :gs-h="5"
                                                :gs-id="4">
                                                <div class="grid-stack-item-content" style="background-color: #FFF;">
                                                    <div style="width: 100%; height:100%;overflow: hidden;">
                                                        <ClientOnly>
...
const addnested = (e) => {
    setTimeout(() => { // 這邊要改成觸發ref機制才對
        ...
        // console.log('addnested', e, parentDiv.getBoundingClientRect().height);
        let cols = 50
        let rows = 10
        ...
        // gridx.on('gsresizestop', (event, element) => {
    ...
    temp.addEventListener('message', (e) => {
        ...
        if (type === 'open') {
            ...
            for (var i = 0; i < jsonData.length; i++) {
                var index = state.childrenROI.findIndex((item) => item.option.container_index === jsonData[i].container_id)
                console.log('indexindexindex', state.childrenROI[index]);
                state.childrenROI[index].option.hmi = jsonData[i]
            }
            // }
        } else if (type === 'close') {
            temp.terminate();
                    ...
                    if (findeindex === -1) {
                        tempItemAll.push({
                            ...
                            option: container_type === 4 ? { camID: item.container_camera_id } : {
                                ...
                                tabId: findID,
                                container_index: item.container_id,
                                hmi: {
                                    camera_name: '相機1',
                                    realtime_roiCurve: {
                                        cruising_id: 15,
