                            ...
                            <div>
                                <div class="ml-2" style="width: 30px" v-if="item.data.roi_mainGroup_type === 1">
                                    <v-btn flat block color="#00000000" :disabled="props.ptzswitch === 2">
                                        <img src="/images/icon/Group 658307.png" width="30px" />
                                                    ...
                                                    <div class="roi-type-icon-content1 ml-6"
                                                        ...
                                                        <div class="roi-type-icon1">
                                                            <template
                                                                ...
                                                                <img class="ml-2" src="/images/fs/icon/alarm-off.png"
                                                                    width="30px" />
                                                            </template>
                                                            <template v-else>
                                                                <img class="ml-2" src="/images/fs/icon/Doorbell.png"
                                                                    width="30px"
                                                                    v-if="childNodeItem.data.roi_subGroup_alarmStatus === 0" />
                                                                <img class="ml-2" src="/images/fs/icon/alarm-on.png"
                                                                    width="30px" v-else />
                                                            </template>
                                                        </div>
                                                    ...
                                                    <div>
                                                        <div class="ml-2" style="width: 30px">
                                                            <v-btn flat block color="#00000000"
                                                                ...
                                                                <img src="/images/fs/icon/alarm-off.png" width="30px"
                                                                    v-if="item.alarmStatus === 0" />
                                                                <img src="/images/fs/icon/alarm-on.png" width="30px"
                                                        ...
                                                        <div class="tree-table-td tree-table-lv2-0">
                                                            <div class="roi-type-icon-content">
                                                                ...
                                                                <div class="roi-type-icon">
                                                                    <img src="/images/icon/Iconspot.png" width="100%"
                                                                        v-if="childNodeItem2.data.roi_type === 'spot'" />
                                                                    <img src="/images/icon/Iconline.png" width="100%"
                                                                        v-else-if="childNodeItem2.data.roi_type === 'line'" />
                                                                    <img src="/images/icon/Iconscope.png" width="100%"
                                                                        v-else-if="childNodeItem2.data.roi_type === 'scope'" />
                                                                    <img src="/images/icon/Iconblob.png" width="100%"
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <div class="ml-2" style="width: 30px"
                                                                    ...
                                                                    <v-btn flat block color="#00000000"
                                                                        :disabled="props.ptzswitch === 2">
                                                                        <img src="/images/icon/Group 658307.png"
                                                                            width="30px" />
                                                                        <template
                                                                            v-if="item.data.roi_mainGroup_type === 1">
                                                                            <v-menu activator="parent">
