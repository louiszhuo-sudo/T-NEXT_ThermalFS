<template>
    <div id="c-treeView" style="overflow: auto;position: relative;height: 100%;">
        <div class="tree-table" style="font-size:12px;background-color: #F8F8F8;position: sticky; top: 0;">
            ...
            <div class="tree-table-td tree-table-lv3">狀態</div>
            <div class="tree-table-td tree-table-lv4">最高溫度</div>
            <div class="tree-table-td tree-table-lv5">一級/二級閾值</div>
        ...
        <div class="c-treeView-plane c-treeView-plane-active" v-for="(item, i) in state.treeviews" :key="i"
                    ...
                    <div class="c-treeView-plane-h" @click="activeNode">
                        ...
                        <div class="tree-table-td tree-table-lv8 d-flex justify-center"
                            ...
                            <v-checkbox :indeterminate="vCheckboxindeterminatelevel1(item) === 1"
                                ...
                                color="blue"
                                :disabled="item.data.roi_mainGroup_type === 3 || props.ptzswitch === 2"></v-checkbox>
                        </div>
                        <div class="tree-table-td tree-table-lv9 d-flex justify-space-between"
                            ...
                            <div class="c-table-btn mt-1" style="width: 70px;">
                                <v-btn v-if="item.data.roi_mainGroup_type === 1" block
                                    @click="opendialog(item.data, 11)" :disabled="props.ptzswitch === 2">新增子群組</v-btn>
                            </div>
                            <div>
                                <div class="ml-2" style="width: 30px" v-if="item.data.roi_mainGroup_type === 1">
                                    <v-btn flat block color="#00000000" :disabled="props.ptzswitch === 2">
                                        <NuxtImg src="/images/icon/Group 658307.png" width="30px" />
                                        <template v-if="item.data.roi_mainGroup_type === 1">
                                            <v-menu activator="parent">
                                                <div class="d-flex flex-column c-meun-treeview-item">
                                                    <div class="c-meun-treeview"
                                                        v-for="(meunItem1, q) in state.meunItems01" :key="q"
                    ...
                    <template v-if="item?.childNodes">
                        ...
                        <div id="c-treeView">
                            <div class="c-treeView-plane c-treeView-plane-active"
                                v-for="(childNodeItem, w) in item.childNodes" :key="w">
                                    ...
                                    <div class="c-treeView-plane-tag">
                                        <div class="c-treeView-plane-h" @click="activeNode"
                                            ...
                                            <div class=" tree-table-td tree-table-lv3 d-flex justify-center">
                                                <div style="width:100%;">
                                                    <div class="roi-type-icon-content1 ml-6"
                                                        style="pointer-events: auto !important;"
                                                        @mouseenter="(e) => { roitp(e, true); }"
                                                        @mouseout="(e) => { roitp(e, false); }">
                                                        <div class="roi-type-id1"
                                                            v-if="childNodeItem.data.roi_subGroup_alarmContent.length > 0">
                                                            {{
                                                            childNodeItem.data.roi_subGroup_alarmContent.length
                                                            }}
                                                        </div>
                                                        <div class="roi-type-icon1">
                                                            <template
                                                                v-if="vCheckboxindeterminatelevel2(childNodeItem) === 0">
                                                                <NuxtImg class="ml-2"
                                                                    src="/images/fs/icon/alarm-off.png" width="30px" />
                                                            </template>
                                                            <template v-else>
                                                                <NuxtImg class="ml-2" src="/images/fs/icon/Doorbell.png"
                                                                    width="30px"
                                                                    v-if="childNodeItem.data.roi_subGroup_alarmStatus === 0" />
                                                                <NuxtImg class="ml-2" src="/images/fs/icon/alarm-on.png"
                                                                    width="30px" v-else />
                                                            </template>
                                                        </div>
                                                        <div id="roi-items" class="roi-items-tootip d-none"
                                                            v-if="childNodeItem.data.roi_subGroup_alarmContent.length > 0">
                                                            <template
                                                                v-for="(itemSubAlarmContent, j) in childNodeItem.data.roi_subGroup_alarmContent"
                                                                :key="j">
                                                                <div
                                                                    v-if="childNodeItem.data.roi_subGroup_alarmContent.length > 0">
                                                                    {{ itemSubAlarmContent }}
                                                    ...
                                                    <div>
                                                        <div class="ml-2" style="width: 30px">
                                                            <v-btn flat block color="#00000000"
                                                                ...
                                                                <NuxtImg src="/images/fs/icon/alarm-off.png"
                                                                    width="30px" v-if="item.alarmStatus === 0" />
                                                                <NuxtImg src="/images/fs/icon/alarm-on.png" width="30px"
                                            ...
                                            <div class="tree-table-td tree-table-lv9 d-flex justify-space-between"
                                                ...
                                                <div class="c-table-btn mt-1" style="width: 65px;">
                                                    <v-btn v-if="item.data.roi_mainGroup_type === 1"
                                                        :disabled="props.ptzswitch === 2">
                                                        新增ROI <b class="">▼</b>
                                                        <template v-if="item.data.roi_mainGroup_type === 1">
                                                            <v-menu activator="parent">
                                                                <div class="d-flex flex-column c-meun-treeview-item">
                                                                    <div class="c-meun-treeview"
                                                                        v-for="(itemList, a) in state.createRoiItems"
                                                                        :key="a"
                                                    ...
                                                    <div class="ml-2" style="width: 30px"
                                                        ...
                                                        <v-btn flat block color="#00000000"
                                                            ...
                                                            <template v-if="item.data.roi_mainGroup_type === 1">
                                                                <v-menu activator="parent">
                                                                    <div
                                                                        class="d-flex flex-column c-meun-treeview-item">
                                                                        <div class="c-meun-treeview"
                                                                            @click="opendialog(childNodeItem.data, meunItem1.value)"
                                                                            v-for="(meunItem1, s) in state.meunItems02"
                                                                            :key="s">{{ meunItem1.title }}
                                                                        </div>
                                                                    </div>
                                                                </v-menu>
                                                            </template>
                                        ...
                                        <template v-if="childNodeItem?.childNodes">
                                            ...
                                            <div id="c-treeView">
                                                <div class="c-treeView-plane c-treeView-plane-active position-relative"
                                                    v-for="(childNodeItem2, d) in childNodeItem.childNodes" :key="d">
                                                        ...
                                                        <div class="tree-table-td tree-table-lv2-0">
                                                            <div class="roi-type-icon-content">
                                                                ...
                                                                <div class="roi-type-icon">
                                                                    <NuxtImg src="/images/icon/Iconspot.png"
                                                                        width="100%"
                                                                        v-if="childNodeItem2.data.roi_type === 'spot'" />
                                                                    <NuxtImg src="/images/icon/Iconline.png"
                                                                        width="100%"
                                                                        v-else-if="childNodeItem2.data.roi_type === 'line'" />
                                                                    <NuxtImg src="/images/icon/Iconscope.png"
                                                                        width="100%"
                                                                        v-else-if="childNodeItem2.data.roi_type === 'scope'" />
                                                                    <NuxtImg src="/images/icon/Iconblob.png"
                                                                        width="100%"
                                                            ...
                                                            <div class="d-flex align-center justify-center">
                                                                <div style="width:100%;">
                                                                    <div class="ml-2" style="width: 30px">
                                                                        <div style="width:100%;">
                                                                            <!-- 2 -->
                                                                            <div class="roi-type-icon-content1"
                                                                                @mouseenter="(e) => { roitp(e, true); }"
                                                                                @mouseout="(e) => { roitp(e, false); }">
                                                                                <div class="roi-type-id1"
                                                                                    v-if="childNodeItem2.data.roi_alarmContent.length > 0">
                                                                                    {{
                                                                                    childNodeItem2.data.roi_alarmContent.length
                                                                                    }}
                                                                                </div>
                                                                                <div class="roi-type-icon1">
                                                                                    <template
                                                                                        ...
                                                                                        <NuxtImg class="ml-2"
                                                                                            src="/images/fs/icon/alarm-off.png"
                                                                                            width="30px" />
                                                                                    </template>
                                                                                    <template v-else>
                                                                                        <NuxtImg class="ml-2"
                                                                                            src="/images/fs/icon/Doorbell.png"
                                                                                            width="30px"
                                                                                            v-if="childNodeItem2.data.roi_alarmStatus === 0" />
                                                                                        <NuxtImg class="ml-2"
                                                                                            src="/images/fs/icon/alarm-on.png"
                                                                                            width="30px" v-else />
                                                                                    </template>
                                                                                </div>
                                                                                <div id="roi-items"
                                                                                    class="roi-items-tootip d-none"
                                                                                    v-if="childNodeItem2.data.roi_alarmContent.length > 0">
                                                                                    <template
                                                                                        v-for="(itemSubAlarmContent1, f) in childNodeItem2.data.roi_alarmContent"
                                                                                        :key="f">
                                                                                        <div
                                                                                            v-if="childNodeItem2.data.roi_alarmContent.length > 0">
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <div class="ml-2" style="width: 30px"
                                                                    ...
                                                                    <v-btn flat block color="#00000000"
                                                                        :disabled="props.ptzswitch === 2">
                                                                        <NuxtImg src="/images/icon/Group 658307.png"
                                                                            width="30px" />
                                                                        <template
                                                                            v-if="item.data.roi_mainGroup_type === 1">
                                                                            <v-menu activator="parent">
                                                                                <div
                                                                                    class="d-flex flex-column c-meun-treeview-item">
                                                                                    <div class="c-meun-treeview"
                                                                                        v-for="(meunItem1, g) in state.meunItems03"
                                                                                        :key="g"
...
const state = reactive({
    ...
    tempsubGroup: null,
    webWorker02: null,
    meunItems01: [{ title: '修改名稱', value: 7 }, { title: '刪除主群組', value: 10 }],
    meunItems02: [{ title: '修改名稱', value: 8 }, { title: '修改二級警報溫度', value: 2 }, { title: '修改溫差警報溫度', value: 14 }, { title: '刪除次群組', value: 12 }],
    meunItems03: [{ title: '修改名稱', value: 6 }, { title: '修改群組', value: 13 }, { title: '刪除項目', value: 5 }]
})
// watch(
...
const roitp = (e, type) => {
    const roiItems = e.target ? e.target.querySelector('#roi-items') : null;
    if (roiItems !== null && type) {
        ...
        roiItems.style.left = x + (width + 10) + "px"
        roiItems.style.top = y + height + "px"
        roiItems.classList.remove('d-none')
    } else if (roiItems !== null && !type) {
...
.roi-type-icon-content1:hover {
    background-color: #e7e7e7;
}

.roi-type-icon-content1:active {
    background-color: #c4c4c4;
}
