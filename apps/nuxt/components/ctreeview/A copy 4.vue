...
<template>
                        ...
                        <div class="tree-table-td tree-table-lv9 d-flex justify-space-between"
                            ...
                            <div>
                                <div class="ml-2" style="width: 30px" v-if="item.data.roi_mainGroup_type === 1">
                                    ...
                                    <!-- <img src="/images/fs/icon/more.png" width="30px" /> -->
                                    <!-- <template v-if="item.data.roi_mainGroup_type === 1">
                                            <v-menu activator="parent">
                                                <v-list>
                                                    <v-list-item v-for="(meunItem1, q) in state.meunItems01" :key="q"
                                                ...
                                                <div style="width:100%;">
                                                    <!-- <v-btn class="text-none" flat block color="#00000000">
                                                        <v-badge color="error"
                                                            ...
                                                            <template> -->
                                                    <!--  <template v-if="vCheckboxindeterminatelevel2(childNodeItem) === 0"> -->
                                                    ...
                                                    <!-- </v-badge>
                                                        <v-tooltip activator="parent" location="end">
                                                            <template
                                                                v-for="(itemSubAlarmContent, r) in childNodeItem.data.roi_subGroup_alarmContent"
                                                                :key="r">
                                                                <div
                                            ...
                                            <div class="tree-table-td tree-table-lv9 d-flex justify-space-between"
                                                ...
                                                <div class="c-table-btn mt-1" style="width: 65px;">
                                                    <!-- <v-menu v-if="item.data.roi_mainGroup_type === 1">
                                                        <template v-slot:activator="{ props123 }">
                                                            <v-btn v-bind="props123">
                                                                新增ROI <b class="">▼</b>
                                                            </v-btn>
                                                        </template>
                                                        <v-list>
                                                            <v-list-item v-for="(itemList, a) in state.createRoiItems"
                                                                :key="a" :value="a"
    ...
    <template v-else>
                                                                                        ...
                                                                                        <img src="/images/fs/icon/alarm-on.png"
                                                                                            width="30px" v-else />
                                                                                    </template>
    </v-badge>
    <v-tooltip activator="parent" location="end">
        <template v-for="(itemSubAlarmContent1, f) in childNodeItem2.data.roi_alarmContent" :key="f">
                                                                                        <div
                                                        ...
                                                        <div class="tree-table-td tree-table-lv7">
                                                            ...
                                                            <v-checkbox v-model="selected" value="Jacob"
