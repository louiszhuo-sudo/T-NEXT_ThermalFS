...
// const ptzinto = useAttrs().ptzinto
// const displayObject10 = useAttrs().displayObject10
// const alarmPTZlist = useAttrs().ptzAlarmID
...
const leafletJsInitForPhoto = () => {
    ...
    //     iconSize: [34, 34],
    // });
    // var marker = L.marker([-50, 50], { draggable: false }).addTo(map);
    // var marker2 = L.marker([-100, 300], { icon: myIcon, draggable: true }).addTo(map);
    // var angle = 25
    ...
    //     r = r - 360
    // }
    // var rw = runRadiusUser(marker.getLatLng().lat, marker.getLatLng().lng, calculatePixelDistance(marker2.getLatLng(), marker.getLatLng()), r, angle)
    ...
    //         r = r - 360
    //     }
    //     rw = runRadiusUser(latlng.lat, latlng.lng, calculatePixelDistance(marker2.getLatLng(), latlng), r, angle)
    // });
    ...
    //         r = r - 360
    //     }
    //     rw = runRadiusUser(marker.getLatLng().lat, marker.getLatLng().lng, calculatePixelDistance(latlng, marker.getLatLng()), r, angle)
    // });
...
const leafletJsInit = () => {
    ...
    if (camType === 'ir') {
        // sendSR()
        // const runTimeOut = () => {
        //     state.tempSRstatusTimeout = setTimeout(() => {
        //         sendSR()
        //         runTimeOut()
        //     }, 10 * 1000)
        // }
        // runTimeOut()
        runRTC(`video${camType}${camID}-${state.randomID}`, `http://localhost:${currentPort}/video/realtime/${camType}${camID}`, 'vis')
    } else {
...
const superResolution = (e) => {
    ...
    if (state.tempSRstatus !== e) {
        if (e) {
            ...
            runRTC(`video${camType}${camID}-${state.randomID}`, `http://localhost:${currentPort}/video/realtime/${camType}${camID}_SR`, 'vis')
        } else {
