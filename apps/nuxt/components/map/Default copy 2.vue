...
watch(
    ...
    (e, prevData) => {
        if (false) {
                                            ...
                                            if (data[item.roi_type] !== undefined) {
                                                if (item.roi_type === 'scope') {
                                                    data.scope.push({
                                                        ...
                                                        // "temperature_max": parseFloat((Math.random() * 1000).toFixed(2)),
                                                        "temperature_min": 0,
                                                        "temperature_point": {
                                                            "median": {
            ...
            state.mainGroupItems = mainGroupItems
            // state.subGroupItems = subGroupItems
...
const pixiaddScope = (data, name, tempPointID) => {
    ...
    if (true) {
        ...
        rectangular.on('mousedown', (e) => {
            if (props.mainMode === 'roi' && !state.blobStatusAdd) {
...
const createRevisionCheckBox = (e) => {
    ...
    state.checkChangeBox = L.marker([getBounds[0][1].lat + 25, getBounds[0][3].lng + 5], { icon: checkChangeBoxDiv, draggable: false }).addTo(map);
