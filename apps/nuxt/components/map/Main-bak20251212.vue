                                        ...
                                        <div class="menu-ptz-item">
                                            ...
                                            <div class="pa-1">
                                                <v-select hide-details :items="state.cursingPointItems"
                                                    ...
                                                    :menu-props="{ maxHeight: 1080, location: 'top' }" :disabled="state.ptzswitch === 2"
                                                    density="compact">
                ...
                <div class="item-canvas pa-1" ref="anchorPoint">
                    <div class="item-card-content position-relative">
                        ...
                        <div :style="state.tablemode === 1 ? 'visibility: hidden !important;pointer-events: none !important;' : ''"
                            ...
                            <video :id="state.className" style="width: 100%;height: 100%;" autoplay muted></video>
                            <!-- <ClientOnly>
                                    <MapOnlyvideo ref="mapImport4" :camID="camID" :camType="'roiChart'"
                                        :test="'test111'" />
                                </ClientOnly> -->
                        </div>
